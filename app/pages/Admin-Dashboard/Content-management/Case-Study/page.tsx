  ...
  return (
    ...
    <h4 className="text-lg font-bold text-white">Blogs</h4>
      ...
      <div className="border border-purple-500/30 rounded-2xl bg-[#0f0f1e] p-6 space-y-5">
        <h5 className="text-lg font-normal text-white">Add New Case Study</h5>
  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
      ...
      <div className="max-w-3xl space-y-4">
        {/* Title */}
        <h5 className="text-2xl font-bold text-white leading-snug whitespace-pre-line">{blog.title}</h5>
